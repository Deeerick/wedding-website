...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function updateCountdown() {
        // Data do casamento: 26/08/2023 às 15:30
        const weddingDate = new Date('2023-08-26T15:30:00');
        const now = new Date();
        ...
        // Atualizar elementos na página (hero section)
        ...
        // Atualizar elementos na navbar (mobile)
        const navDaysElement = document.getElementById('nav-days');
        const navHoursElement = document.getElementById('nav-hours');
        const navMinutesElement = document.getElementById('nav-minutes');
        const navSecondsElement = document.getElementById('nav-seconds');

        if (navDaysElement) navDaysElement.textContent = days;
        if (navHoursElement) navHoursElement.textContent = hours.toString().padStart(2, '0');
        if (navMinutesElement) navMinutesElement.textContent = minutes.toString().padStart(2, '0');
        if (navSecondsElement) navSecondsElement.textContent = seconds.toString().padStart(2, '0');
    }
